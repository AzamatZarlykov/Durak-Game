...
declare let idsOfPlayers: number[];
...
declare function setPlayingPlayers(count: number): void;
declare function placePlayers(newDiv: HTMLDivElement, pos: number[]): void;
declare function setHTMLForPlayers(newDiv: HTMLDivElement, player: number): void;
declare function shuffle(): number[];
declare function removeDOM(htmlID: string): void;
...
declare function setOtherPlayerIDs(): void;
declare function removeFromPlayingPlayers(idToDelete: number): void;
